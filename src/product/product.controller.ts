...
export class ProductController {
  ...
  @Post('/create')
  async createPost(@Res() res: Response, @Body() createProductDTO: CreateProductDTO): Promise<Response<Product>> {
  ...
  @Get('/:productID')
  async getProduct(@Res() res: Response, @Param('productID') productID: string): Promise<Response<Product>> {
  ...
  @Delete('/delete')
  async deleteProduct(@Res() res: Response, @Query('productID') productID: string): Promise<Response<Product>> {
